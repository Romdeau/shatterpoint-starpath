export const ListBuilderPage = () => {
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-500">
      <div className="flex flex-col">
        <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-zinc-400">
          Squad Construction Interface
        </h2>
        <span className="text-[9px] font-aurebesh text-emerald-500/40 uppercase">logic in production</span>
      </div>
